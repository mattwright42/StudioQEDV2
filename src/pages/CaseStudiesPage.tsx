...
const caseStudies: CaseStudyData[] = [
  ...
  },
  {
    ...
    background:
      'We directed and designed every element for this limited-edition release. Studio QED provided all the art direction to produce multiple original illustrations, custom window-box packaging, soundtrack and character cards, and even a custom-crafted nine-inch plush baby dragon!',
                ...
                >
                  ...
                  <div className="grid md:grid-cols-2 gap-10">
                    <div>
                      ...
                      <p className="text-[#5F5644] leading-relaxed text-lg">{study.background}</p>
                    </div>
                    ...
                    <div>
                      ...
                      {typeof study.results === 'string' ? (
                        <p className="text-[#5F5644] leading-relaxed text-lg">{study.results}</p>
                      ) : (
                        <img
